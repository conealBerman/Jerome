...
// DEFINE META BOXES
	$peopleMetaBoxArray = array(
	    ...
	    "people_work_title_meta" => array(
	    	"id" => "people_work_title_meta",
	        "name" => "Work Title",
	        "post_type" => "people",
	        "position" => "side",
	        "priority" => "low",
	    ...
	    "people_work_email_meta" => array(
	    	"id" => "people_work_email_meta",
	        "name" => "Work Email",
	        "post_type" => "people",
	        "position" => "side",
	        "priority" => "low",
	        "callback_args" => array(
	        	"input_type" => "input_text",
	        	"input_name" => "work_email"
	        )
	    ),
	    "people_work_phone_meta" => array(
	    	"id" => "people_work_phone_meta",
	        "name" => "Work Phone",
	        "post_type" => "people",
	        "position" => "side",
	        "priority" => "low",
